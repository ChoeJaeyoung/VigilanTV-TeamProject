    ...
    $.ajax({
        ...
        success: function(args) {
	        ...
	        for(var i =0; i<7; i++){
		        ...
		        $("#result").append("<tr text-align='center' scope='rows' bgcolor='white'><td text-align='center'>"+json.plate_num+"</td><td text-align='center'>"+json.date_detect+" "+json.time_detect+"</td></tr>");
